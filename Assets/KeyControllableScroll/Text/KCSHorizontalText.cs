...
{
    public class KCSHorizontalText
    {
        public static string GenerateText(string kcsName, string dataSourceArgument, string instantiateText, string dataSourceSetData)
        {
...
{
    [AddComponentMenu(""UI/KCS/" + kcsName + @""", 100)]
    public class " + kcsName + @" : KeyControllableScrollBase
    {

    #region 変数定義

        // Cell Recycle
        public I" + kcsName + @"DataSource DataSource;
        private ScrollRect scrollRect;
        private RectTransform cellListRT;
        private (GameObject go, RectTransform rectT" + dataSourceArgument + @")[] recycleArray;
        ...
        // ScrollKeyControl
        public I" + kcsName + @"ScrollKeyMoved ScrollKeyMoved;
        public I" + kcsName + @"ScrollKeyInput ScrollKeyInput;
        private bool isFocusChasingScroll;

        // FocusKeyControl
        public I" + kcsName + @"FocusKeyMoved FocusKeyMoved;
        public I" + kcsName + @"FocusKeyInput FocusKeyInput;
    ...
    #region 初期化
        ...
        override public void Init()
        {
            ...
            recycleArray = new (GameObject go, RectTransform rectT" + dataSourceArgument + @")[maxDisplayCellNum];
